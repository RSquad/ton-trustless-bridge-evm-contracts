...
import { proofBoc, proofBoc3, txBoc, txBoc2, txBoc3, txParseBoc4, txParseBoc5, txParseBoc6, txParseBoc7 } from "./data/index";
...
describe("Greeter", function () {
  it("Should deploy Adapter", async function () {
    ...
    // const bocHeaderInfo = await adapter.parse_serialized_header(txParseBoc5);
    // console.log("Boc Header: ============");
    // console.log(clearData(bocHeaderInfo));

    // const cells = await adapter.get_tree_of_cells(txParseBoc5, bocHeaderInfo);
    // // const cells: any = res;
    // console.log("CELLS: ==============");
    ...
    // const data = await adapter.deserializeMsgData(txParseBoc5);
    // console.log("Data: ==============");
